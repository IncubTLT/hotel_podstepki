...
!function ($) {
    ...
    function Plugin(action, options) {
        ...
        return this.each(function () {
            ...
            data || (data = new Accordion($this, $.extend(!0, {}, options)), $this.data("vc.accordion", data)),
    ...
    (Accordion = function ($element, options) {
        ...
        Accordion.prototype.getTriggers = function () {
            ...
            return this.getContainer().find("[data-vc-accordion]").each(function () {
                ...
                void 0 === accordion && ($this.vcAccordion(), accordion = $this.data("vc.accordion")),
