...
!function (e, t) {
    ...
    window.RSANYID = window.RSANYID === t ? [] : window.RSANYID,
        ...
        e.extend(!0, i, {
            pageHandler: function (r) {
                ...
                for (var s in o)
                    o.hasOwnProperty(s) && (i.RS_toInit[o[s].id] = !1, i.RS_prioList.push(o[s].id));
                i.nextSlider = r,
            ...
            leaveViewPort: function (a) {
                i[a].sliderlaststatus = i[a].sliderstatus,
                    i[a].c.trigger("stoptimer"),
                    i[a].playingvideos != t && i[a].playingvideos.length > 0 && (i[a].lastplayedvideos = e.extend(!0, [], i[a].playingvideos), i[a].playingvideos && e.each(i[a].playingvideos, function (e, t) {
            ...
            scrollHandling: function (e, a, r, o) {
                if (i[e] !== t) {
                    ...
                    i[e].viewPort.enable && ("%" === i[e].viewPort.vaType[i[e].level] && (i[e].viewPort.visible_area[i[e].level] <= n || n >= 0 && n <= 1 && i[e].sbtimeline.fixed) || "px" === i[e].viewPort.vaType[i[e].level] && (s.top <= 0 && s.bottom >= i.lastwindowheight || s.top >= 0 && s.bottom <= i.lastwindowheight || s.top >= 0 && s.top < i.lastwindowheight - i[e].viewPort.visible_area[i[e].level] || s.bottom >= i[e].viewPort.visible_area[i[e].level] && s.bottom < i.lastwindowheight) ? i[e].inviewport || (i[e].inviewport = !0, i.enterViewPort(e, !0), i[e].c.trigger("enterviewport")) : i[e].inviewport && (i[e].inviewport = !1, i.leaveViewPort(e), i[e].c.trigger("leftviewport"))),
                        i[e].inviewport && (i.callBackHandling && i.callBackHandling(e, "parallax", "start"), requestAnimationFrame(function () {
            ...
            getWindowDimension: function (e) {
                !1 === e ? (i.winWAll = window.innerWidth, i.winWSbar = document.documentElement.clientWidth, a ? (i.zoom = i.winWSbar / i.winWAll, i.winW = 1 !== i.zoom ? i.winWSbar * i.zoom : Math.min(i.winWAll, i.winWSbar), i.winH = 1 !== i.zoom ? window.innerHeight * i.zoom : window.innerHeight, i.scrollBarWidth = 0) : (i.scrollBarWidth = i.winWAll - i.winWSbar, i.winW = Math.min(i.winWAll, i.winWSbar), i.winH = window.innerHeight), a && i.winH > 125 && (i.lastwindowheight !== t && Math.abs(i.lastwindowheight - i.winH) < 125 ? i.mobileWinH = i.lastwindowheight : i.mobileWinH = i.winH)) : clearTimeout(i.windowDimenstionDelay),
                    i.windowDimenstionDelay = setTimeout(function () {
                        i.winWAll = window.innerWidth,
                            i.winWSbar = document.documentElement.clientWidth,
                            a ? (i.zoom = i.winWSbar / i.winWAll, i.RS_px_ratio = window.devicePixelRatio || window.screen.availWidth / document.documentElement.clientWidth, i.winW = 1 !== i.zoom ? i.winWSbar * i.zoom : Math.min(i.winWAll, i.winWSbar), i.winH = 1 !== i.zoom ? window.innerHeight * i.zoom : window.innerHeight, i.scrollBarWidth = 0) : (i.scrollBarWidth = i.winWAll - i.winWSbar, i.winW = Math.min(i.winWAll, i.winWSbar), i.winH = window.innerHeight),
            ...
            revModal: function (a, r) {
                if (a !== t && i[a] !== t && "clicked" !== i[a].modal.closeProtection) {
                    if (!0 === i[a].modal.closeProtection)
                        return i[a].modal.closeProtection, void setTimeout(function () {
                    ...
                    switch (r.mode) {
                        case "show":
                            ...
                            i.isModalOpen = !0,
                                tpGS.gsap.fromTo(o, i[a].modal.coverSpeed / 5, {
                                    a: 0
                                }, {
                                    a: 10,
                                    ease: "power3.inOut",
                        ...
                        if (l.hasOwnProperty(c)) {
                            ...
                            for (d in p)
                                if (p.hasOwnProperty(d) && "length" !== d && !(p[d].className.indexOf("rs-pzimg") >= 0)) {
                                    ...
                                    f && f.progress && f.progress.match(/inprogress|inload|prepared/g) && (!f.error && e.now() - f.starttoload < 3e3 ? n = !0 : (f.progress = "failed", f.reported_img || (f.reported_img = !0, console.log(h + "  Could not be loaded !")))),
            ...
            updateVisibleArea: function (a) {
                for (var r in i[a].viewPort.visible_area = i.revToResp(i[a].viewPort.visible_area, i[a].rle, "0px"), i[a].viewPort.vaType = new Array(4), i[a].viewPort.visible_area)
                    i[a].viewPort.visible_area.hasOwnProperty(r) && (e.isNumeric(i[a].viewPort.visible_area[r]) && (i[a].viewPort.visible_area[r] += "%"), i[a].viewPort.visible_area[r] !== t && (i[a].viewPort.vaType[r] = i[a].viewPort.visible_area[r].indexOf("%") >= 0 ? "%" : "px"), i[a].viewPort.visible_area[r] = parseInt(i[a].viewPort.visible_area[r], 0), i[a].viewPort.visible_area[r] = "%" == i[a].viewPort.vaType[r] ? i[a].viewPort.visible_area[r] / 100 : i[a].viewPort.visible_area[r])
            },
            observeFonts: function (e, a, r) {
                r = r === t ? 0 : r,
                    i.fonts === t && (i.fonts = {}, i.monoWidth = l("monospace"), i.sansWidth = l("sans-serif"), i.serifWidth = l("serif")),
                    r++;
                var o = i.fonts[e];
                !0 !== i.fonts[e] && (i.fonts[e] = i.monoWidth !== l(e + ",monospace") || i.sansWidth !== l(e + ",sans-serif") || i.serifWidth !== l(e + ",serif")),
                    100 === r || (!1 === o || o === t) && !0 === i.fonts[e] ? (l(e + ",monospace", !0), l(e + ",sans-serif", !0), l(e + ",serif", !0), a()) : setTimeout(function () {
                ...
                if (r !== t && r.length < 9)
                    if (r.split("slide").length > 1 && -1 == r.indexOf("slider")) {
                        ...
                        for (var n in i[a].slides)
                            i[a].slides.hasOwnProperty(n) && i.gA(i[a].slides[n], "deeplink") == r && (o = parseInt(n) + 1);
                return o
            },
            ...
            getComingSlide: function (a, r) {
                var o = i[a].pr_next_key !== t ? i[a].pr_next_key : i[a].pr_processing_key !== t ? i[a].pr_processing_key : i[a].pr_active_key,
                    s = 0;
                if (s = 0, i[a].pr_active_slide !== t && "true" == i.gA(i[a].pr_active_slide[0], "not_in_nav") && (o = i[a].pr_lastshown_key), r !== t && e.isNumeric(r) || r !== t && r.match(/to/g))
            ...
            getResponsiveLevel: function (e) {
                ...
                if (i[e].responsiveLevels && i[e].responsiveLevels.length)
                    for (var s in i[e].responsiveLevels)
                        i[e].responsiveLevels.hasOwnProperty(s) && (i.winWAll < i[e].responsiveLevels[s] && (0 == a || a > parseInt(i[e].responsiveLevels[s])) && (t = parseInt(i[e].responsiveLevels[s]), o = parseInt(s), a = parseInt(i[e].responsiveLevels[s])), i.winWAll > i[e].responsiveLevels[s] && a < i[e].responsiveLevels[s] && (a = parseInt(i[e].responsiveLevels[s]), r = parseInt(s)));
                return a < t ? r : o
            },
            ...
            updateDims: function (e, a) {
                ...
                i[e].drawUpdates.cpar.height = g,
                    ...
                    "auto" === i[e].sliderLayout || "fullscreen" === i[e].sliderLayout && !0 === i[e].disableForceFullWidth || i[e].rsFullWidthWrap === t ? "fullscreen" == i[e].sliderLayout && 1 == i[e].disableForceFullWidth && (i[e].drawUpdates.cpar.left = 0) : i[e].drawUpdates.cpar.left = 0 - Math.ceil(i[e].rsFullWidthWrap.offset().left - (i[e].outNavDims.left + i[e].block.left)),
                    ...
                    i[e].drawUpdates.cpar !== i[e].emptyObject && JSON.stringify(i[e].drawUpdates.cpar) !== i[e].caches.setsizeCPAROBJ && (i[e].caches.setsizeCPAROBJ = JSON.stringify(i[e].drawUpdates.cpar), l = !0, i[e].redraw.cpar = !0),
                    ...
                    i[e].slayers && i[e].slayers.length > 0 && i[e].outNavDims.left !== i[e].caches.outNavDimsLeft && "fullwidth" != i[e].sliderLayout && "fullscreen" != i[e].sliderLayout && (i[e].caches.outNavDimsLeft = i[e].outNavDims.left, i[e].redraw.slayers = !0),
                    s && i[e].modal.calibration !== t && "middle" === i[e].modal.vertical && (i[e].modal.calibration.top = i.getWinH(e) < g ? "0%" : "50%", i[e].modal.calibration.y = i.getWinH(e) < g ? "0px" : "-50%", "fullwidth" === i[e].sliderLayout && (l = !0, i[e].redraw.modulewrap = !0)),
                    ...
                    window.requestAnimationFrame(function () {
                        i[e].redraw.forcer && tpGS.gsap.set(i[e].forcer, {
                            ...
                            i[e].redraw.modalcanvas && tpGS.gsap.set([i[e].modal.c, i[e].canvas], {
                                width: i[e].canv.width
                            }),
                            ...
                            i[e].redraw.slayers && tpGS.gsap.set(i[e].slayers, {
                                left: i[e].outNavDims.left
                            }),
                            i[e].redraw.modulewrap && tpGS.gsap.set(i[e].modal.c.find("rs-module-wrap"), i[e].modal.calibration),
                            !0 !== i[e].navigation.initialised && "prepared" === a && ("hero" !== i[e].sliderType && i.createNavigation && i[e].navigation.use && !0 !== i[e].navigation.createNavigationDone && i.createNavigation(e), i.resizeThumbsTabs && i.resizeThumbsTabs && i[e].navigation.use && i.resizeThumbsTabs(e)),
            ...
            loadUpcomingContent: function (e) {
                if ("smart" == i[e].lazyType) {
                    ...
                    r !== a && t.push(i[e].slides[r]),
                        ...
                        t.length > 0 && (i.loadImages(t, e, 2), i.waitForCurrentImages(t, e, function () { }))
                }
            },
            ...
            buildSpinner: function (i, a, r, o) {
                ...
                if ("off" !== a) {
                    ...
                    if (isNaN(n) || n < 6) {
                        ...
                        if (7 === n)
                            -1 !== r.search("#") ? (c = r.replace("#", ""), c = "rgba(" + parseInt(c.substring(0, 2), 16) + ", " + parseInt(c.substring(2, 4), 16) + ", " + parseInt(c.substring(4, 6), 16) + ", ") : -1 !== r.search("rgb") && (c = r.substring(r.indexOf("(") + 1, r.lastIndexOf(")")).split(",")).length > 2 && (c = "rgba(" + c[0].trim() + ", " + c[1].trim() + ", " + c[2].trim() + ", "),
    ...
    var a = i.is_mobile(),
        ...
        l = function (e, a) {
            if (i["rsfont_" + e] == t && (i["rsfont_" + e] = document.createElement("span"), i["rsfont_" + e].innerHTML = Array(100).join("wi"), i["rsfont_" + e].style.cssText = ["position:absolute", "width:auto", "font-size:128px", "left:-99999px"].join(" !important;"), i["rsfont_" + e].style.fontFamily = e, document.body.appendChild(i["rsfont_" + e])), a === t)
        ...
        c = function (r) {
            ...
            if (i[r].cpar !== t && i[r].cpar.data("aimg") != t && ("enabled" == i[r].cpar.data("aie8") && i.isIE(8) || "enabled" == i[r].cpar.data("amobile") && a))
                ...
                for (var c in i[r].notInNav = [], i[r].slides = [], l)
                    l.hasOwnProperty(c) && ("on" == i.gA(l[c], "hsom") && a ? d.push(l[c]) : (i.gA(l[c], "invisible") || 1 == i.gA(l[c], "invisible") ? i[r].notInNav.push(l[c]) : (i[r].slides.push(l[c]), i[r].slideamount++), i[r].realslideamount++, i.sA(l[c], "originalindex", i[r].realslideamount), i.sA(l[c], "origindex", i[r].realslideamount - 1)));
                for (c in d)
                    d.hasOwnProperty(c) && d[c].remove();
                for (c in i[r].notInNav)
                    i[r].notInNav.hasOwnProperty(c) && (i.sA(i[r].notInNav[c], "not_in_nav", !0), i[r].canvas[0].appendChild(i[r].notInNav[c]));
                if (i[r].canvas.css({
                    visibility: "visible"
            ...
            if (i[r] !== t) {
                        ...
                        if (i[r].thumbs[l] = e.extend({}, !0, f), d > 0 && tpGS.gsap.set(u, {
                            ...
                            if (_ != t && "no" != _ && "next" != _ && "prev" != _)
                                for (var x in i[r].slides)
                                    i[r].slides.hasOwnProperty(x) && parseInt(i.gA(i[r].slides[x], "origindex"), 0) + 1 == i.gA(u, "linktoslide") && (_ = i.gA(i[r].slides[x], "key"));
                ...
                if (i[r].forceOverflow && i[r].topc[0].classList.add("rs-forceoverflow"), "carousel" === i[r].sliderType && !0 !== i[r].overflowHidden && i[r].c.css({
                        ...
                        if (L.hasOwnProperty(T)) {
                            ...
                            if (I.startclasses = L[T].className, I.startclasses = I.startclasses === t || null === I.startclasses ? "" : I.startclasses, I.animationonscroll = !!i[r].sbtimeline.set && i[r].sbtimeline.layers, I.animationonscroll = !0 === I.animationonscroll || "true" == I.animationonscroll, I.filteronscroll = !!i[r].scrolleffect.set && i[r].scrolleffect.layers, I.pxundermask = I.startclasses.indexOf("rs-pxmask") >= 0 && "off" !== i[r].parallax.type && I.startclasses.indexOf("rs-pxl-") >= 0, I.noPevents = I.startclasses.indexOf("rs-noevents") >= 0, I.sba)
                                for (var y in R = I.sba.split(";"))
                                    R.hasOwnProperty(y) && ("t" == (O = R[y].split(":"))[0] && (I.animationonscroll = O[1], "false" == O[1] && (I.animOnScrollForceDisable = !0)), "e" == O[0] && (I.filteronscroll = O[1]), "so" == O[0] && (I.scrollBasedOffset = parseInt(O[1]) / 1e3));
                            if ("true" != I.animationonscroll && 1 != I.animationonscroll || (I.startclasses += " rs-sba", A[0].className += " rs-sba"), I.startclasses.indexOf("rs-layer-static") >= 0 && i.handleStaticLayers && i.handleStaticLayers(A, r), "RS-BGVIDEO" !== A[0].tagName) {
                                if (A[0].classList.add("rs-layer"), "column" === I.type && (I.columnwidth = "33.33%", I.verticalalign = "top", I.column !== t))
                                    for (var C in R = I.column.split(";"))
                                        R.hasOwnProperty(C) && ("w" === (O = R[C].split(":"))[0] && (I.columnwidth = O[1]), "a" === O[0] && (I.verticalalign = O[1]));
                                ...
                                "row" === I.type || "column" === I.type || "group" === I.type ? (A[0].classList.remove("tp-resizeme"), "column" === I.type && (I.width = "auto", A[0].group = "row", tpGS.gsap.set(A, {
                                    width: "auto"
                                }), I.filteronscroll = !1)) : (H = "display:" + ("inline-block" === A[0].style.display ? "inline-block" : "block") + ";", null !== i.closestNode(A[0], "RS-COLUMN") ? (A[0].group = "column", I.filteronscroll = !1) : null !== i.closestNode(A[0], "RS-GROUP-WRAP") && (A[0].group = "group", I.filteronscroll = !1)),
                                    I.wrpcls !== t && (M = M + " " + I.wrpcls),
                                    I.wrpid !== t && (j = 'id="' + I.wrpid + '"'),
                                    A.wrap("<" + G + " " + j + ' class="rs-parallax-wrap ' + M + '" style="' + P + " " + z + B + H + F + '"><rs-loop-wrap style="' + z + B + H + '"><rs-mask-wrap style="' + z + B + H + '">' + (I.pxundermask ? "<rs-px-mask></rs-px-mask>" : "") + "</rs-mask-wrap></rs-loop-wrap></" + G + ">"),
                                    ...
                                    i.revCheckIDS(r, A[0]),
                                    I.pxundermask ? i[r]._Lshortcuts[A[0].id] = {
                            ...
                            i.gA(A[0], "actions") && i.checkActions && i.checkActions(A, r, i[r]),
                                !i.checkVideoApis || window.rs_addedvim && window.rs_addedyt || i[r].youtubeapineeded && i[r].vimeoapineeded || i.checkVideoApis(A, r)
                        }
                    i.checkActions && i.checkActions(t, r),
                        ...
                        i[r].rs_static_layer.length > 0 && (i.loadImages(i[r].rs_static_layer[0], r, 0, !0), i.waitForCurrentImages(i[r].rs_static_layer[0], r, function () {
                            ...
                            i[r].rowzones[y] = [],
                                ...
                                E.find("rs-zone").each(function () {
                                    i[r].rowzones[y].push(e(this)),
                                        this.className.indexOf("rev_row_zone_middle") >= 0 && i[r].middleZones[y].push(this)
                                }),
                    ...
                    i[r].srowzones = [],
                        ...
                        i.document.on("updateContainerSizes." + i[r].c.attr("id"), function () {
                            if (i[r] !== t)
                                return i[r].c != t && void (i.updateDims(r, "ignore") && window.requestAnimationFrame(function () {
                ...
                if (window.requestAnimationFrame(function () {
                    ...
                    if ("carousel" == i[e].sliderType && i.prepareCarousel(e), "standard" === i[e].sliderType && i[e].mtl !== t && i.animateSlide({
                        ...
                        for (var s in i[e].panzoomTLs)
                            i[e].panzoomTLs.hasOwnProperty(s) && i.startPanZoom(i[e].panzoomBGs[s], e, i[e].panzoomTLs[s].progress(), s, i[e].panzoomTLs[s].isActive() ? "play" : "reset");
                    else
        ...
        v = function (a) {
            ...
            i[a].startWithSlide = i[a].startWithSlide === t ? t : Math.max(1, (i[a].sliderType, parseInt(i[a].startWithSlide))),
                i[a].cpar.css({
                    overflow: "visible"
                }),
            ...
            for (var o = 0; o < i[a].slides.length; o++) {
                ...
                p.src = n[0].src,
                    ...
                    l.length > 0 && (l.addClass("defaultvid").css({
                        zIndex: 30
                    }), c !== t && "" !== c && "none" !== c && l.addClass(c), l.appendTo(d), p.parallax != t && (l.data("parallax", p.parallax), l.data("showcoveronpause", "on"), l.data("mediafilter", c))),
        ...
        O = function (a, r) {
            if (i[a] !== t)
                if (clearTimeout(i[a].waitWithSwapSlide), i[a].pr_processing_key === t || !0 !== i[a].firstSlideShown) {
                    if (clearTimeout(i[a].waitWithSwapSlide), i[a].startWithSlideKey !== t && (i[a].pr_next_key = i.getComingSlide(a, i[a].startWithSlideKey).nindex, delete i[a].startWithSlideKey), i[a].pr_active_slide = e(i[a].slides[i[a].pr_active_key]), i[a].pr_next_slide = e(i[a].slides[i[a].pr_next_key]), i[a].pr_next_key == i[a].pr_active_key)
                    ...
                    i[a].pr_processing_key = i[a].pr_next_key,
                        ...
                        i[a].stopLoop && i[a].pr_processing_key == i[a].lastslidetoshow - 1 && (i[a].progressC.css({
                            visibility: "hidden"
                        }), i[a].c.trigger("revolution.slide.onstop"), i[a].noloopanymore = 1),
            ...
            if (i[r] !== t) {
                if (C(r), i[r].pr_active_slide = e(i[r].slides[i[r].pr_active_key]), i[r].pr_next_slide = e(i[r].slides[i[r].pr_processing_key]), i[r].pr_active_bg = i[r].pr_active_slide.find("rs-sbg-wrap"), i[r].pr_next_bg = i[r].pr_next_slide.find("rs-sbg-wrap"), i[r].tonpause = !1, clearTimeout(i[r].loadertimer), i[r].loader !== t && !0 === i[r].loaderVisible && (window.requestAnimationFrame(function () {
                    ...
                    i[r].mtl = tpGS.gsap.timeline({
                        ...
                        i.gA(i[r].pr_next_slide[0], "firstanim") != t && "done" != i.gA(i[r].pr_next_slide[0], "differentissplayed") && (i.sA(i[r].pr_next_slide[0], "savedanim", i.gA(i[r].pr_next_slide[0], "anim")), i.sA(i[r].pr_next_slide[0], "anim", i.gA(i[r].pr_next_slide[0], "firstanim")), i.sA(i[r].pr_next_slide[0], "differentissplayed", "prepared"));
                    var s = function (e) {
        ...
        if (i[r] !== t) {
            ...
            if (i[r].firstSlideAvailable === t && (i[r].firstSlideAvailable = !0, window.requestAnimationFrame(function () {
                ...
                i.sA(i[r].c[0], "slideactive", s),
                    ...
                    i[r].pr_next_bg.data("panzoom") !== t && (i[r].panzoomTLs !== t && i[r].panzoomTLs[i.getSlideIndex(r, s)] !== t ? (i[r].panzoomTLs[i.getSlideIndex(r, s)].timeScale(1), i[r].panzoomTLs[i.getSlideIndex(r, s)].play()) : i.startPanZoom(i[r].pr_next_bg, r, 0, i.getSlideIndex(r, s), "play")),
                ...
                i[r].rowzones != t && (d = d > i[r].rowzones.length ? i[r].rowzones.length : d),
                    i[r].rowzones != t && i[r].rowzones.length > 0 && i[r].rowzones[d] != t && d >= 0 && d <= i[r].rowzones.length && i[r].rowzones[d].length > 0 && i.updateDims(r),
                ...
                if (i[a].progressC = e('<rs-progress style="visibility:hidden;"></rs-progress>'), "horizontal" === r.style || "vertical" === r.style) {
                    if ("module" === r.basedon) {
                        ...
                        i[a].progressC[0].innerHTML = "<rs-progress-bar></rs-progress-bar>",
                            !0 === i[a].noDetach && i[a].c.append(i[a].progressC);
                    i[a].progressCBarInner = i.getByTag(i[a].progressC[0], "RS-PROGRESS-BAR"),
            ...
            i[e].progressC == t && C(e),
                ...
                i[e].c.on("restarttimer", function () {
                    if (i[e].progressC != t && !i[e].forcepaused) {
                        if (i[e].mouseoncontainer && "on" == i[e].navigation.onHoverStop && !a)
                            return !1;
                        1 === i[e].noloopanymore || i[e].viewPort.enable && !i[e].inviewport || 1 == i[e].ssop ? i.unToggleState(i[e].slidertoggledby) : (i[e].progressBar.visibility[i[e].level] || (i[e].progressC[0].style.visibility = "visible"), i[e].progressC[0].tween !== t && i[e].progressC[0].tween.kill(), i[e].progressC[0].tween = P(e), i[e].progressC[0].tween.play(), i[e].sliderstatus = "playing", i.toggleState(i[e].slidertoggledby)),
                ...
                i[e].c.on("tp-mouseenter", function () {
                    i[e].mouseoncontainer = !0,
                        1 != i[e].navigation.onHoverStop || a || (i[e].c.trigger("stoptimer"), i[e].c.trigger("revolution.slide.onpause"))
                }),
                i[e].c.on("tp-mouseleft", function () {
                    i[e].mouseoncontainer = !1,
                        1 != i[e].c.data("conthover") && 1 == i[e].navigation.onHoverStop && (1 == i[e].viewPort.enable && i[e].inviewport || 0 == i[e].viewPort.enable) && (i[e].c.trigger("revolution.slide.onresume"), i[e].c.trigger("starttimer"))
                })
        },
        M = function () {
        ...
        H = function (a) {
            if (i[a].blockSpacing !== t) {
                ...
                i[a].blockSpacing.block = e(i.closestClass(i[a].c[0], "wp-block-themepunch-revslider")),
                    i[a].level !== t && i[a].blockSpacing !== t && tpGS.gsap.set(i[a].blockSpacing.block, {
            ...
            return function (i) {
                ...
                if (e.isNumeric(i.scrolleffect.tilt) || -1 !== i.scrolleffect.tilt.indexOf("%") && (i.scrolleffect.tilt = parseInt(i.scrolleffect.tilt)), i.scrolleffect.tilt = i.scrolleffect.tilt / 100, i.navigation.thumbnails.position = "outer-horizontal" == i.navigation.thumbnails.position ? "bottom" == i.navigation.thumbnails.v_align ? "outer-bottom" : "outer-top" : "outer-vertical" == i.navigation.thumbnails.position ? "left" == i.navigation.thumbnails.h_align ? "outer-left" : "outer-right" : i.navigation.thumbnails.position, i.navigation.tabs.position = "outer-horizontal" == i.navigation.tabs.position ? "bottom" == i.navigation.tabs.v_align ? "outer-bottom" : "outer-top" : "outer-vertical" == i.navigation.tabs.position ? "left" == i.navigation.tabs.h_align ? "outer-left" : "outer-right" : i.navigation.tabs.position, i.sbtimeline.speed = parseInt(i.sbtimeline.speed, 0) / 1e3 || .5, !0 === i.sbtimeline.set && !0 === i.sbtimeline.fixed && "auto" !== i.sliderLayout ? (i.sbtimeline.fixStart = parseInt(i.sbtimeline.fixStart), i.sbtimeline.fixEnd = parseInt(i.sbtimeline.fixEnd)) : i.sbtimeline.fixed = !1, i.progressBar === t || "true" != i.progressBar.disableProgressBar && 1 != i.progressBar.disableProgressBar || (i.progressBar.disableProgressBar = !0), i.startDelay = parseInt(i.startDelay, 0) || 0, i.navigation !== t && i.navigation.arrows != t && i.navigation.arrows.hide_under != t && (i.navigation.arrows.hide_under = parseInt(i.navigation.arrows.hide_under)), i.navigation !== t && i.navigation.bullets != t && i.navigation.bullets.hide_under != t && (i.navigation.bullets.hide_under = parseInt(i.navigation.bullets.hide_under)), i.navigation !== t && i.navigation.thumbnails != t && i.navigation.thumbnails.hide_under != t && (i.navigation.thumbnails.hide_under = parseInt(i.navigation.thumbnails.hide_under)), i.navigation !== t && i.navigation.tabs != t && i.navigation.tabs.hide_under != t && (i.navigation.tabs.hide_under = parseInt(i.navigation.tabs.hide_under)), i.navigation !== t && i.navigation.arrows != t && i.navigation.arrows.hide_over != t && (i.navigation.arrows.hide_over = parseInt(i.navigation.arrows.hide_over)), i.navigation !== t && i.navigation.bullets != t && i.navigation.bullets.hide_over != t && (i.navigation.bullets.hide_over = parseInt(i.navigation.bullets.hide_over)), i.navigation !== t && i.navigation.thumbnails != t && i.navigation.thumbnails.hide_over != t && (i.navigation.thumbnails.hide_over = parseInt(i.navigation.thumbnails.hide_over)), i.navigation !== t && i.navigation.tabs != t && i.navigation.tabs.hide_over != t && (i.navigation.tabs.hide_over = parseInt(i.navigation.tabs.hide_over)), i.lazyloaddata !== t && i.lazyloaddata.length > 0 && i.lazyloaddata.indexOf("-") > 0) {
                    ...
                    for (i.lazyloaddata = r[0], a = 1; a < r.length; a++)
                        i.lazyloaddata += j(r[a])
                }
                return i.duration = parseInt(i.duration), "single" === i.lazyType && "carousel" === i.sliderType && (i.lazyType = "smart"), "carousel" === i.sliderType && i.carousel.justify && (i.justifyCarousel = !0, i.keepBPHeight = !0), i.enableUpscaling = 1 == i.enableUpscaling && "carousel" !== i.sliderType && "fullwidth" === i.sliderLayout, i.useFullScreenHeight = "carousel" === i.sliderType && "fullscreen" === i.sliderLayout && !0 === i.useFullScreenHeight, i.progressBar.y = parseInt(i.progressBar.y, 0), i.progressBar.x = parseInt(i.progressBar.x, 0), /*! Custom Eases */
        ...
        jQuery.extend(!0, t, {
            ...
            organiseCarousel: function (e, i, a, r, o) {
                ...
                for (var h = 2 * s.windhalf, f = 0, v = -1, y = 0; y < s.len; y++)
                    !0 === s.justify ? (p += y > 0 ? s.slide_widths[y - 1] + s.space : s.slide_offset, s.wrapwidth >= s.maxwidth && "center" !== s.horizontal_align && (s.slideFakePositions[y] = p - s.slide_offset), c = 0 - s.slide_widths[y], d = s.maxwidth - s.slide_widths[y], s.inneroffset = 0) : (p = y * s.slide_width + s.slide_offset, s.wrapwidth >= s.maxwidth && "left" === s.horizontal_align && (s.slideFakePositions[y] = y * s.slide_width), s.wrapwidth >= s.maxwidth && "right" === s.horizontal_align && (s.slideFakePositions[y] = s.wrapwidth - (y + 1) * s.slide_width)),
                        u = g = p,
                ...
                if (t[e].slides)
                    for (y = 0; y < t[e].slides.length; y++) {
                        var k = {
                            ...
                            S = 0;
                        if (void 0 === s.slideAnims[y] && (k.transformOrigin = "50% " + s.vertical_align, k.scale = 1, k.force3D = !0, k.transformStyle = "3D" != t[e].parallax.type && "3d" != t[e].parallax.type ? "flat" : "preserve-3d"), s.justify)
                            k.autoAlpha = 1,
                                s.wrapwidth >= s.maxwidth && "center" !== s.horizontal_align || ("center" === s.horizontal_align && s.slidepositions[y] < s.windhalf && s.slidepositions[y] + s.slide_widths[y] > s.windhalf ? s.focused = y : "left" === s.horizontal_align && s.slidepositions[y] >= -25 && s.slidepositions[y] < s.windhalf && (!w || s.slidepositions[y] < x) ? (s.focused = y, w = !0, x = s.slidepositions[y]) : "right" === s.horizontal_align && s.slidepositions[y] + s.slide_widths[y] <= s.wrapwidth + 25 && (s.slide_widths[y] < s.windhalf && s.slidepositions[y] > s.windhalf || s.slidepositions[y] > s.wrapwidth - s.slide_widths[y]) && (!w || s.slidepositions[y] > x) && (s.focused = y, w = !0, x = s.slidepositions[y]), s.focused = s.focused >= s.len ? s.infinity ? 0 : s.len - 1 : s.focused < 0 ? s.infinity ? s.len - 1 : 0 : s.focused);
                        else {
                            S = "center" === s.horizontal_align ? (Math.abs(s.wrapwidth / 2) - (k.left + s.slide_width / 2)) / s.slide_width : (s.inneroffset - k.left) / s.slide_width,
                                ...
                                void 0 !== s.minScale && s.minScale > 0 && (s.vary_scale ? k.scale = 1 - Math.abs((1 - s.minScale) / l * S) : k.scale = S >= 1 || S <= -1 ? s.minScale : s.minScale + (1 - s.minScale) * (1 - Math.abs(S)), _ = S * (k.width - k.width * k.scale) / 2),
                            ...
                            k.autoAlpha = void 0 === k.autoAlpha ? 1 : k.autoAlpha,
                                ...
                                void 0 !== s.maxRotation && 0 != Math.abs(s.maxRotation) && (s.vary_rotation ? (k.rotationY = Math.abs(s.maxRotation) - Math.abs((1 - Math.abs(1 / l * S)) * s.maxRotation), k.autoAlpha = Math.abs(k.rotationY) > 90 ? 0 : k.autoAlpha) : k.rotationY = S >= 1 || S <= -1 ? s.maxRotation : Math.abs(S) * s.maxRotation, k.rotationY = S < 0 ? -1 * k.rotationY : k.rotationY, t.isSafari11() && (k.z = 0 !== S ? 0 - Math.abs(k.rotationY) : 0)),
                        ...
                        k.x += s.wrapwidth >= s.maxwidth && ("left" === s.horizontal_align || "right" === s.horizontal_align) ? s.slideFakePositions[y] : Math.floor(k.left),
                            ...
                            !0 !== o && (void 0 !== s.slideAnims[y] && (k.width === s.slideAnims[y].width && delete k.width, k.x === s.slideAnims[y].x && delete k.x, k.autoAlpha === s.slideAnims[y].autoAlpha && delete k.autoAlpha, k.scale === s.slideAnims[y].scale && delete k.scale, k.zIndex === s.slideAnims[y].zIndex && delete k.zIndex, k.rotationY === s.slideAnims[y].rotationY && delete k.rotationY), tpGS.gsap.set(t[e].slides[y], k), s.slideAnims[y] = jQuery.extend(!0, s.slideAnims[y], k))
                    }
                ...
                if (i.distance = void 0 !== e.distance ? e.distance : e.to, void 0 !== i.positionanim && i.positionanim.pause(), e.fix) {
                    if (!1 !== i.snap) {
                        ...
                        i.slide_offset = e.to,
                            ...
                            Math.abs(i.swipeDistance) > 40 && n == i.focused && (i.focused = "right" === e.direction ? i.focused - 1 : i.focused + 1, i.focused = i.focused >= i.len ? i.infinity ? 0 : i.len - 1 : i.focused < 0 ? i.infinity ? i.len - 1 : 0 : i.focused),
                            r.to += t.carouselToEvalPosition(e.id, e.direction, !0),
                            i.slide_offset = s,
                            t.organiseCarousel(e.id, e.direction, !0, !1, !1),
                            i.keepFocusedFirst && (i.keepFocusedFirst = !1, i.focused = 0)
                    } else
                        !0 !== i.infinity ? (r.to > 0 && (r.to = 0), r.to < i.wrapwidth - i.maxwidth && (r.to = i.wrapwidth - i.maxwidth)) : "end" === e.phase ? i.dragModeJustEnded = !0 : !0 !== i.dragModeJustEnded ? r.to += t.carouselToEvalPosition(e.id, e.direction, !0) : i.dragModeJustEnded = !1;
                    ...
                    i.positionanim = tpGS.gsap.to(r, o, {
                        ...
                        onComplete: function () {
                            i.slide_offset = r.from % i.maxwidth,
                                ...
                                i.justDragged = !1,
                                e.fix && (i.focusedAfterAnimation = i.focused, e.newSlide && i.focusedBeforeSwipe !== i.focused && t.callingNewSlide(e.id, jQuery(t[e.id].slides[i.focused]).data("key"), !0), t.organiseCarousel(e.id, e.direction, !0, !0), t[e.id].c.trigger("revolution.slide.carouselchange", {
                                    slider: e.id,
                    ...
                    for (var r = 0; r < a.len; r++)
                        if (t[e].slides.hasOwnProperty(r)) {
                            ...
                            o = void 0 === o || 0 === o || null === o ? a.ratio : o,
                                ...
                                a.slide_widths[r] !== a.slide_widthsCache[r] && (a.slide_widthsCache[r] = a.slide_widths[r], !0 !== i && tpGS.gsap.set(t[e].slides[r], {
    ...
    function (e) {
        ...
        jQuery.extend(!0, o, {
            ...
            requestLayerUpdates: function (e, t, i, a) {
                ...
                if (void 0 !== i)
                    r = i,
                        o[e]._L[r].pVisRequest !== o[e]._L[r].pVisStatus && (void 0 === o[e]._L[r]._ligid || !0 !== o[e]._L[o[e]._L[r]._ligid].childrenAtStartNotVisible ? (o[e]._L[r].pVisStatus = o[e]._L[r].pVisRequest, 0 === o[e]._L[r].pVisStatus ? "row" !== o[e]._L[r].type && "column" !== o[e]._L[r].type && "group" !== o[e]._L[r].type || void 0 === o[e]._L[r].frames || void 0 === o[e]._L[r].frames.frame_999 || void 0 === o[e]._L[r].frames.frame_999.transform || "" + o[e]._L[r].frames.frame_999.transform.opacity == "0" ? o[e]._L[r].p[0].classList.add("rs-forcehidden") : o[e]._L[r].p[0].classList.add("rs-forceuntouchable") : (o[e]._L[r].p[0].classList.remove("rs-forceuntouchable"), o[e]._L[r].p[0].classList.remove("rs-forcehidden"))) : (o[e]._L[r].p[0].classList.remove("rs-forceuntouchable"), o[e]._L[r].p[0].classList.add("rs-forcehidden"))),
                        o[e]._L[r].pPointerStatus !== o[e]._L[r].pPeventsRequest && (o[e]._L[r].pPointerStatus = o[e]._L[r].pPeventsRequest, tpGS.gsap.set(o[e]._L[r].p[0], {
                ...
                if (o[e].rowzones && o[e].rowzones.length > 0) {
                    if (void 0 !== o[e].rowzones[r])
                        for (var n = 0; n < o[e].rowzones[r].length; n++)
                            o[e].rowzonesHeights[r][n] = o[e].rowzones[r][n][0].offsetHeight,
                                t += o[e].rowzonesHeights[r][n];
                    if (s !== r)
                        for (n = 0; n < o[e].rowzones[s].length; n++)
                            o[e].rowzonesHeights[s][n] = o[e].rowzones[s][n][0].offsetHeight,
                ...
                for (var n in o[r].layers[e.skey])
                    if (o[r].layers[e.skey].hasOwnProperty(n)) {
                        ...
                        if (u = "slide" === p.basealign ? 0 : Math.max(0, "fullscreen" == o[r].sliderLayout ? o[r].module.height / 2 - o.iHE(r) * (o[r].keepBPHeight ? 1 : o[r].CM.h) / 2 : o[r].autoHeight || null != o[r].minHeight && o[r].minHeight > 0 || o[r].keepBPHeight ? o[r].canv.height / 2 - o.iHE(r) * o[r].CM.h / 2 : u), g = "slide" === p.basealign ? 0 : Math.max(0, g), "slide" !== p.basealign && "carousel" === o[r].sliderType && p._isstatic && void 0 !== o[r].carousel && void 0 !== o[r].carousel.horizontal_align && (g = Math.max(0, "center" === o[r].carousel.horizontal_align ? 0 + (o[r].module.width - o.iWA(r, "static") * o[r].CM.w) / 2 : "right" === o[r].carousel.horizontal_align ? o[r].module.width - o[r].gridwidth[o[r].level] * o[r].CM.w : g)), "updateposition" !== e.mode) {
                            if (0 == p.vbility[o[r].levelForced] || "f" == p.vbility[o[r].levelForced] || h < o[r].hideLayerAtLimit && "on" == p.layeronlimit || h < o[r].hideAllLayerAtLimit ? (!0 !== p.layerIsHidden && p.p[0].classList.add("rs-layer-hidden"), p.layerIsHidden = !0) : (p.layerIsHidden && p.p[0].classList.remove("rs-layer-hidden"), p.layerIsHidden = !1), p.poster = null == p.poster && void 0 !== p.thumbimage ? p.thumbimage : p.poster, "image" === p.layertype)
                                if (p.imgOBJ = {}, "cover-proportional" === p.img.data("c")) {
                                    ...
                                    void 0 === p.group && "auto" === p.width[o[r].level] && "auto" === p.height[o[r].level] && (p.width[o[r].level] = o.gA(p.img[0], "owidth", p.img[0].width), p.height[o[r].level] = o.gA(p.img[0], "owidth", p.img[0].height)),
                                        p.imgOBJ = {
                        ...
                        if ("preset" !== e.mode) {
                            ...
                            (1 == o[r].gridEQModule || void 0 !== p._lig && "row" !== p.type && "column" !== p.type && "group" !== p.type) && (M = void 0 !== p._lig ? p._lig.width() : o[r].module.width, G = void 0 !== p._lig ? p._lig.height() : o[r].module.height, g = 0, u = 0),
                                b = "c" === b || "m" === b || "center" === b || "middle" === b ? M / 2 - p.eow / 2 + B : "l" === b || "left" === b ? B : "r" === b || "right" === b ? M - p.eow - B : "off" !== p.rsp_o ? b * o[r].CM.w : b,
                                _ = "m" === _ || "c" === _ || "center" === _ || "middle" === _ ? G / 2 - p.eoh / 2 + z : "t" === _ || "top" == _ ? z : "b" === _ || "bottom" == _ ? G - p.eoh - z : "off" !== p.rsp_o ? _ * o[r].CM.w : _,
                                ...
                                p._ingroup && (void 0 !== p._groupw && !jQuery.isNumeric(p._groupw) && p._groupw.indexOf("%") > 0 && (p.OBJUPD.lppmOBJ.minWidth = p._groupw), void 0 !== p._grouph && !jQuery.isNumeric(p._grouph) && p._grouph.indexOf("%") > 0 && (p.OBJUPD.lppmOBJ.minHeight = p._grouph)),
            ...
            animateTheLayers: function (e) {
                ...
                void 0 !== i && o[t].layers[i] && o.initLayer({
                    ...
                    "preset" !== e.mode || void 0 !== o[t].slidePresets && void 0 !== o[t].slidePresets[e.slide] || (o[t].slidePresets = void 0 === o[t].slidePresets ? {} : o[t].slidePresets, o[t].slidePresets[e.slide] = !0, o[t].c.trigger("revolution.slideprepared", {
                        slide: e.slide
                    })),
                ...
                if (("containerResized_2" !== e.caller && "swapSlideProgress_2" !== e.caller || !0 === m.animationRendered) && (m.animationRendered = !0, "preset" !== e.mode || !0 === m.frames.frame_1.timeline.waitoncall || void 0 !== m.scrollBasedOffset)) {
                    if ("trigger" == e.mode && (m.triggeredFrame = e.frame), m._isstatic) {
                        ...
                        if (_ = x === m.endslide && "continue" === e.mode || ("continue" === e.mode || x === m.endslide) && "none", !0 === e.allforce || !0 === _) {
                            if ("continue" === e.mode && "frame_999" === e.frame && (L || void 0 === m.lastRequestedMainFrame))
                                return
                        } else {
                            if ("preset" === e.mode && (m.elementHovered || !L))
                                return;
                            if ("rebuild" === e.mode && !S && !L)
                                return;
                            if ("start" === e.mode && L && "frame_1" === m.lastRequestedMainFrame)
                                return;
                            if (("start" === e.mode || "preset" === e.mode) && "frame_999" === m.lastRequestedMainFrame && !0 !== m.leftstage)
                                return;
                            if ("continue" === e.mode && "frame_999" === e.frame && (L || void 0 === m.lastRequestedMainFrame))
                                return;
                            if ("start" === e.mode && !L)
                        ...
                        "start" === e.mode && "keep" !== m.triggercache && (m.triggeredFrame = void 0);
                        ...
                        if (m.ford.hasOwnProperty(T)) {
                            ...
                            if ("frame_0" !== R && "frame_hover" !== R && "loop" !== R) {
                                if ("frame_999" === R && !m.frames[R].timeline.waitoncall && m.frames[R].timeline.start >= o[r].duration && !0 !== e.remove && (m.frames[R].timeline.waitoncall = !0), "start" === e.mode && "keep" !== m.triggercache && (m.frames[R].timeline.callstate = m.frames[R].timeline.waitoncall ? "waiting" : ""), "trigger" === e.mode && m.frames[R].timeline.waitoncall && (R === e.frame ? (m.frames[R].timeline.triggered = !0, m.frames[R].timeline.callstate = "called") : m.frames[R].timeline.triggered = !1), "rebuild" === e.mode || m.frames[R].timeline.triggered || (m.frames[R].timeline.callstate = m.frames[R].timeline.waitoncall ? "waiting" : ""), !1 !== e.fastforward) {
                                    if (("continue" === e.mode || "trigger" === e.mode) && !1 === v && R !== e.frame)
                                        continue;
                                    if (("rebuild" === e.mode || "preset" === e.mode) && !1 === v && void 0 !== m.triggeredFrame && R !== m.triggeredFrame)
                                        continue;
                                ...
                                if (R !== e.frame && m.frames[R].timeline.waitoncall && "called" !== m.frames[R].timeline.callstate && (f = !0), R !== e.frame && v && (f = !0 === f && m.frames[R].timeline.waitoncall ? "skiprest" : !0 !== f && f), void 0 === m.hideonfirststart && "frame_1" === R && m.frames[R].timeline.waitoncall && (m.hideonfirststart = !0), f && "waiting" === m.frames[R].timeline.callstate && "preset" === e.mode && 1 != m.firstTimeRendered) {
                                    if (m._isstatic && void 0 === m.currentframe)
                                        continue;
                                    O = !0,
                                        m.firstTimeRendered = !0
                                } else if ("skiprest" === f || "called" !== m.frames[R].timeline.callstate && f && e.toframe !== R)
                                    continue;
                                if ("frame_999" !== R || !1 !== _ || "continue" !== e.mode && "start" !== e.mode && "rebuild" !== e.mode) {
                                    m.fff = "frame_1" === R && ("trigger" !== e.mode || "frame_999" === m.currentframe || "frame_0" === m.currentframe || void 0 === m.currentframe),
                                        "trigger" === e.mode && "frame_1" === e.frame && !1 === m.leftstage && (m.fff = !1),
                                        O || (m.frames[R].timeline.callstate = "called", m.currentframe = R);
                                    var A = m.frames[R],
                                    ...
                                    if (D.force3D = !0, "block" === B.type && (B.ft[0].background = A.sfx.fxc, B.ft[0].visibility = "visible", B.ft[1].visibility = "visible", C.add(tpGS.gsap.fromTo(B.bmask_in, M / 2, B.ft[0], B.ft[1], 0)), C.add(tpGS.gsap.fromTo(B.bmask_in, M / 2, B.ft[1], B.t, M / 2)), "frame_0" !== R && "frame_1" !== R || (N.opacity = 0)), void 0 !== A.color ? D.color = A.color : void 0 !== m.color && "npc" !== m.color[s] && (D.color = m.color[s]), void 0 !== I && void 0 !== I.color ? N.color = I.color : void 0 !== I && void 0 !== m.color && "npc" !== m.color[s] && (N.color = m.color[s]), void 0 !== A.bgcolor ? A.bgcolor.indexOf("gradient") >= 0 ? D.background = A.bgcolor : D.backgroundColor = A.bgcolor : !0 === m.bgcolinuse && (m.bgcol.indexOf("gradient") >= 0 ? D.background = m.bgcol : D.backgroundColor = m.bgcol), void 0 !== I && (void 0 !== I.bgcolor ? I.bgcolor.indexOf("gradient") >= 0 ? N.background = I.bgcolor : N.backgroundColor = I.bgcolor : !0 === m.bgcolinuse && (m.bgcol.indexOf("gradient") >= 0 ? N.background = m.bgcol : N.backgroundColor = m.bgcol)), void 0 !== m.splitText && !1 !== m.splitText)
                                        for (var W in t)
                                            if (void 0 !== A[t[W]] && !m.quickRendering) {
                                                ...
                                                m.color[s] === D.color && "frame_1" === R || (V.color = D.color),
                                                    void 0 !== N && m.color[s] !== N.color && (Q.color = N.color),
                                                    void 0 !== Q && Q.color !== D.color && (V.color = D.color);
                                                var X = o.clone(V),
                                                ...
                                                delete X.dir,
                                                    ...
                                                    m.fff ? C.add(z.fromTo(E, J, X), 0) : C.add(z.to(E, X), 0),
                                                    G = Math.max(G, E.length * Y)
                                            }
                                    if (M += G, void 0 === i && (i = "isometric" === o[r].perspectiveType ? 0 : "local" === o[r].perspectiveType ? void 0 !== D.transformPerspective ? D.transformPerspective : m.fff && void 0 !== N.transfromPerspective ? N.transfromPerspective : o[r].perspective : o[r].perspective), m.knowTransformPerspective = i, m.pxundermask || void 0 !== H && (void 0 !== I && "hidden" === I.mask.overflow || "hidden" === A.mask.overflow))
                                        C.add(tpGS.gsap.to(m.m, .001, {
                                            overflow: "hidden"
                                        }), 0),
                                            "column" === m.type && C.add(tpGS.gsap.to(m.cbgmask, .001, {
                                                overflow: "hidden"
                                            }), 0),
                                            m.btrans && (j && (j.rotationX = m.btrans.rX, j.rotationY = m.btrans.rY, j.rotationZ = m.btrans.rZ, j.opacity = m.btrans.o), H.rotationX = m.btrans.rX, H.rotationY = m.btrans.rY, H.rotationZ = m.btrans.rZ, H.opacity = m.btrans.o),
                                            m.fff ? C.add(tpGS.gsap.fromTo([m.m, m.cbgmask], M, o.clone(j), o.clone(H)), .001) : C.add(tpGS.gsap.to([m.m, m.cbgmask], M, o.clone(H)), .001);
                                        ...
                                        0 === m.btrans.rX && 0 == m.btrans.rY || (m.maskHasPerspective = !0, U.transformPerspective = i),
                                            C.add(tpGS.gsap.to(m.m, .001, U), 0)
                                    } else
                                        C.add(tpGS.gsap.to(m.m, .001, {
                                    ...
                                    D.force3D = "auto",
                                        m.fff ? (D.visibility = "visible", void 0 !== m.cbg && C.fromTo(m.cbg, M, N, D, 0), o[r].BUG_safari_clipPath && (N.clipPath || D.clipPath || m.spike) && (N.z && parseInt(N.z, 10) || (N.z = -1e-4), D.z && parseInt(D.z, 10) || (D.z = 0)), void 0 !== m.cbg && "column" === m.type ? C.fromTo(P, M, n(N), n(D), 0) : C.fromTo(P, M, N, D, 0), C.invalidate()) : ("frame_999" !== m.frame && (D.visibility = "visible"), void 0 !== m.cbg && C.to(m.cbg, M, D, 0), !o[r].BUG_safari_clipPath || !D.clipPath && !m.spike || D.z && parseInt(D.z, 10) || (D.z = 0 - .01 * Math.random()), void 0 !== m.cbg && "column" === m.type ? C.to(P, M, n(D), 0) : C.to(P, M, D, 0)),
                                        void 0 !== F && "object" != typeof F && "function" != typeof F && F.indexOf("SFXBounce") >= 0 && C.to(P, M, {
                                            scaleY: .5,
                                            scaleX: 1.3,
                                            ease: D.ease + "-squash",
                                    ...
                                    m.timeline.addLabel(R, Z),
                                        m.timeline.add(C, Z),
                                        m.timeline.addLabel(R + "_end", "+=0.01"),
                                        C.eventCallback("onStart", c, [{
                                            id: r,
                                            frame: R,
                                            L: a,
                                            tPE: i
                    ...
                    if (void 0 !== m.frames.loop) {
                        ...
                        if (m.loop.root.add(m.loop.preset, 0), m.loop.root.add(m.loop.move, ee), m.loop.root.add(m.loop.rotate, ee), m.loop.root.add(m.loop.scale, ee), m.loop.root.add(m.loop.filter, ee), "blur(0px) grayscale(0%) brightness(100%)" === re && "blur(0px) grayscale(0%) brightness(100%)" === oe && (re = "none", oe = "none"), ae.originX = ie.originX, ae.originY = ie.originY, ae.originZ = ie.originZ, void 0 === i && (i = "isometric" === o[r].perspectiveType ? 0 : "local" === o[r].perspectiveType && void 0 !== D ? void 0 !== D.transformPerspective ? D.transformPerspective : m.fff && void 0 !== N.transfromPerspective ? N.transfromPerspective : o[r].perspective : o[r].perspective), m.frames.loop.timeline.curved) {
                            ...
                            for (var de in ne)
                                ne.hasOwnProperty(de) && (le.path[de] = ne[se], se = ++se == ne.length ? 0 : se);
                            ("trigger" !== e.mode && "frame_999" !== e.frame || "frame_999" !== e.frame) && m.loop.preset.fromTo(m.lp, ee, {
                                ...
                                m.loop.move.to(m.lp, m.frames.loop.timeline.yoyo_move ? K / 2 : K, {
                                    motionPath: le,
                        ...
                        m.loop.filter.to(m.lp, m.frames.loop.timeline.yoyo_filter ? K / 2 : K, ce),
                    ...
                    if (void 0 !== m.frames.frame_hover && ("start" === e.mode || void 0 === m.hoverframeadded)) {
                        ...
                        pe = 0 === pe ? 1e-5 : pe,
                            m.hoverlistener || (m.hoverlistener = !0, o.document.on("mouseenter mousemove", ("column" === m.type ? "#" + m.cbg[0].id + "," : "") + "#" + m.c[0].id, function (e) {
                                if ("mousemove" !== e.type || !0 !== m.ignoremousemove) {
                                    if (m.animationonscroll || m.readyForHover) {
                                        if (m.elementHovered = !0, m.hovertimeline || (m.hovertimeline = tpGS.gsap.timeline({
                                            ...
                                            m.svgHTemp.fill = t,
                                                m.hovertimeline.to(m.svg, pe, m.svgHTemp, 0),
                                                m.hovertimeline.to(m.svgPath, pe, {
                                                    fill: t
                                                }, 0)
                                        }
                                ...
                                m.elementHovered = !1,
                                    (m.animationonscroll || m.readyForHover) && void 0 !== m.hovertimeline && (m.hovertimeline.reverse(), m.hovertimeline.eventCallback("onReverseComplete", o.hoverReverseDone, [{
                                        id: r,
                                        L: a
                                    }]))
                            }))
                        ...
                        if ("true" != m.animationonscroll && 1 != m.animationonscroll ? m.timeline.play(m.tSTART) : m.timeline.time(m.tSTART), jQuery.inArray(m.type, ["group", "row", "column"]) >= 0 && void 0 !== e.frame) {
                            ...
                            if (!0 === e.updateChildren)
                                for (var W in m.childrenJS)
                                    m.childrenJS.hasOwnProperty(W) && o.renderLayerAnimation({
                                ...
                                for (var W in m.childrenJS)
                                    m.childrenJS.hasOwnProperty(W) && o[r]._L[W].pausedTrueParrent && (o.renderLayerAnimation({
                                        layer: m.childrenJS[W],
                                        fastforward: !1,
                                        id: r,
                                        mode: "continue",
        ...
        var n = function (e) {
            ...
            c = function (e) {
                ...
                var t = o[e.id]._L[e.L[0].id],
                    i = t.hovertimeline;
                i && i.time() > 0 && (i.pause(), i.time(0), i.kill(), delete t.hovertimeline),
            ...
            g = function (e) {
                ...
                s.layer = e.L,
                    ...
                    "frame_999" === e.frame && "leftstage" === s.eventtype ? (o[e.id]._L[e.L[0].id].leftstage = !0, o[e.id]._L[e.L[0].id].pVisRequest = 0, o[e.id]._L[e.L[0].id].pPeventsRequest = "none", t = !1, window.requestAnimationFrame(function () {
            ...
            w = function (e) {
                ...
                for (var l in a)
                    if (a.hasOwnProperty(l)) {
                        if (a[l] = "object" == typeof a[l] ? a[l][o[e.id].level] : a[l], "inherit" === a[l] || "delay" === l || "direction" === l || "use" === l)
                            delete a[l];
            ...
            k = function (e, t) {
                    ...
                    if (e.ford.hasOwnProperty(a)) {
                        ...
                        if (e[n]) {
                            ...
                            e[n + "_mask"] && (i[n].mask = x(e[n + "_mask"], t).transform),
                                null != i[n].mask && i[n].mask.use ? (i[n].mask.x = void 0 === i[n].mask.x ? 0 : i[n].mask.x, i[n].mask.y = void 0 === i[n].mask.y ? 0 : i[n].mask.y, delete i[n].mask.use, i[n].mask.overflow = "hidden") : i[n].mask = {
                                    ease: "default",
                                    overflow: "visible"
                                },
                                ...
                                i[n].transform.auto && (i[n].transform = o.clone(i.frame_0.transform), i[n].transform.opacity = void 0 === i[n].transform.opacity ? 0 : i[n].transform.opacity, void 0 !== i.frame_0.filter && (i[n].filter = o.clone(i.frame_0.filter)), void 0 !== i.frame_0.mask && (i[n].mask = o.clone(i.frame_0.mask)), void 0 !== i.frame_0.chars && (i[n].chars = o.clone(i.frame_0.chars)), void 0 !== i.frame_0.words && (i[n].words = o.clone(i.frame_0.words)), void 0 !== i.frame_0.lines && (i[n].lines = o.clone(i.frame_0.lines)), void 0 === i.frame_0.chars && void 0 === i.frame_0.words && void 0 === i.frame_0.lines || (i[n].dosplit = !0)),
                ...
                for (var a in (e.loop_0 || e.loop_999) && (i.loop = x(e.loop_999, t, !0, "frame_999", "loop"), i.loop.frame_0 = x(e.loop_0 || "", t, !1, void 0, "loop").transform), i.frame_0.transform.opacity = void 0 === i.frame_0.transform.opacity ? 0 : i.frame_0.transform.opacity, i.frame_1.transform.opacity = void 0 === i.frame_1.transform.opacity ? 1 : i.frame_1.transform.opacity, i.frame_999.transform.opacity = void 0 === i.frame_999.transform.opacity ? "inherit" : i.frame_999.transform.opacity, e.clipPath && e.clipPath.use && (i.frame_0.transform.clip = void 0 === i.frame_0.transform.clip ? 100 : parseInt(i.frame_0.transform.clip), i.frame_1.transform.clip = void 0 === i.frame_1.transform.clip ? 100 : parseInt(i.frame_1.transform.clip)), e.resetfilter = !1, i)
                ...
                for (var c in e)
                    if (e.hasOwnProperty(c) && (void 0 !== e[c].timeline && (e[c].timeline.usePerspective = !1), "loop" !== c && "frame_hover" !== c)) {
                        for (a in r.transform)
                            r.transform.hasOwnProperty(a) && (r.transform[a] = void 0 === e[c].transform[a] ? "frame_0" === c ? window.rdF0.transform[a] : "frame_1" === c ? window.rdF1.transform[a] : r.transform[a] : e[c].transform[a], e[c].transform[a] = void 0 === e[c].transform[a] ? r.transform[a] : e[c].transform[a]);
                        for (var p = 1; p <= 4; p++)
                            for (a in r[s[p]])
                                r[s[p]].hasOwnProperty(a) && (e[c][s[p]] = void 0 === e[c][s[p]] ? {} : e[c][s[p]], r[s[p]][a] = void 0 === e[c][s[p]][a] ? "frame_0" === c ? window.rdF0[s[p]][a] : "frame_1" === c ? window.rdF1[s[p]][a] : r[s[p]][a] : e[c][s[p]][a], e[c][s[p]][a] = void 0 === e[c][s[p]][a] ? r[s[p]][a] : e[c][s[p]][a]);
            ...
            O = function (e, t, s) {
                ...
                }, null == l.bshadow && (l.styleProps.boxShadow = e[0].style.boxShadow), "" !== l.styleProps.background && void 0 !== l.styleProps.background && l.styleProps.background !== l.styleProps["background-color"] || delete l.styleProps.background, "" == l.styleProps.color && (l.styleProps.color = o[s].computedStyle[e[0].id].color), n = 0; n < 4; n++)
                    A(l["padding" + i[n]], 0) && delete l["padding" + i[n]],
                        A(l["margin" + i[n]], 0) && delete l["margin" + i[n]],
                        A(l["border" + a[n] + "Radius"], "0px") ? delete l["border" + a[n] + "Radius"] : A(l["border" + a[n] + "Radius"], "0") && delete l["border" + a[n] + "Radius"];
            ...
            z = function (e) {
                var t,
                    ...
                    x = o[f]._L[h[0].id],
                    k = h[0].className;
                if (x = void 0 === x ? {} : x, "object" == typeof k && (k = ""), void 0 !== h && void 0 !== h[0] && (k.indexOf("rs_splitted") >= 0 || "BR" == h[0].nodeName || "br" == h[0].tagName || h[0].tagName.indexOf("FCR") > 0 || h[0].tagName.indexOf("BCR") > 0))
                    return !1;
                ...
                if (void 0 === x._isnotext && (x._isnotext = void 0 !== e.RSL && void 0 !== e.RSL[0] && e.RSL[0].length > 0 ? o.gA(e.RSL[0], "_isnotext") : x._isnotext), x.OBJUPD = null == x.OBJUPD ? {} : x.OBJUPD, x.caches = null == x.caches ? {} : x.caches, "column" === x.type) {
                    for (s = {}, S = {}, t = 0; t < 4; t++)
                        void 0 !== e["margin" + i[t]] && (s["padding" + i[t]] = Math.round(e["margin" + i[t]] * L) + "px", S["margin" + i[t]] = e["margin" + i[t]], delete e["margin" + i[t]]);
                ...
                if (-1 === k.indexOf("rs_splitted_")) {
                    ...
                    if ("IFRAME" == h[0].nodeName && "html" === o.gA(h[0], "layertype") && (u = "slide" == e.basealign ? o[f].module.width : o.iWA(f, b), m = "slide" == e.basealign ? o[f].module.height : o.iHE(f), s.width = !jQuery.isNumeric(e.width) && e.width.indexOf("%") >= 0 ? !x._isstatic || x._incolumn || x._ingroup ? e.width : u * parseInt(e.width, 0) / 100 : I(e.width, L, "auto", u, "auto"), s.height = !jQuery.isNumeric(e.height) && e.height.indexOf("%") >= 0 ? !x._isstatic || x._incolumn || x._ingroup ? e.height : m * parseInt(e.height, 0) / 100 : I(e.height, L, "auto", u, "auto")), _ = jQuery.extend(!0, _, s), "rekursive" != v) {
                        ...
                        if (x._incolumn) {
                            ...
                            R.width = "100%",
                                ...
                                z.width = !jQuery.isNumeric(e.width) && e.width.indexOf("%") >= 0 ? "100%" : O,
                                "image" === x.type && tpGS.gsap.set(x.img, {
                                    width: z.width
                                })
                        } else
                            !jQuery.isNumeric(e.width) && e.width.indexOf("%") >= 0 && (T.minWidth = "slide" === x.basealign || !0 === x._ingroup ? O : o.iWA(f, b) * o[f].CM.w * parseInt(O) / 100 + "px", R.width = "100%", w.width = "100%");
                        if (!jQuery.isNumeric(e.height) && e.height.indexOf("%") >= 0 && (T.minHeight = "slide" === x.basealign || !0 === x._ingroup ? A : o.iHE(f) * (o[f].currentRowsHeight > o[f].gridheight[o[f].level] ? 1 : o[f].CM.w) * parseInt(A) / 100 + "px", R.height = "100%", w.height = "100%", P = !0), x._isnotext || (z.whiteSpace = e.whiteSpace, z.textAlign = e.textAlign, z.textDecoration = e.textDecoration), "npc" != e.color && void 0 !== e.color && (z.color = e.color), x._ingroup && (x._groupw = z.minWidth, x._grouph = z.minHeight), "row" === x.type && (jQuery.isNumeric(z.minHeight) || z.minHeight.indexOf("px") >= 0) && "0px" !== z.minHeight && 0 !== z.minHeight && "0" !== z.minHeight && "none" !== z.minHeight ? z.height = z.minHeight : "row" === x.type && (z.height = "auto"), x._isstatic && x.elementHovered && (p = h.data("frames")) && p.frame_hover && p.frame_hover.transform)
                            for (g in z)
                                z.hasOwnProperty(g) && p.frame_hover.transform.hasOwnProperty(g) && delete z[g];
                        "group" !== x.type && "row" !== x.type && "column" !== x.type && (!jQuery.isNumeric(z.width) && z.width.indexOf("%") >= 0 && (z.width = "100%"), !jQuery.isNumeric(z.height) && z.height.indexOf("%") >= 0 && (z.height = "100%")),
                            x._isgroup && (!jQuery.isNumeric(z.width) && z.width.indexOf("%") >= 0 && (z.width = "100%"), T.height = P ? "100%" : z.height),
                            _ = jQuery.extend(!0, _, z),
                            null != x.svg_src && void 0 !== x.svgI && ("string" == typeof x.svgI.fill && (x.svgI.fill = [x.svgI.fill]), x.svgTemp = o.clone(x.svgI), void 0 !== x.svgTemp.fill && (x.svgTemp.fill = x.svgTemp.fill[o[f].level], tpGS.gsap.set(x.svgPath, {
                    ...
                    if ("column" === x.type && x.cbg && x.cbg.length > 0) {
                        for (void 0 !== x.cbg_img_s && (x.cbg[0].style.backgroundSize = x.cbg_img_s), s = {}, "" !== x.styleProps.cursor && (s.cursor = x.styleProps.cursor), "" !== x.cbg_set && "transparent" !== x.cbg_set && (s.backgroundColor = x.cbg_set), "" !== x.cbg_img && "none" !== x.cbg_img && (s.backgroundImage = x.cbg_img, "" !== x.cbg_img_r && (s.backgroundRepeat = x.cbg_img_r), "" !== x.cbg_img_p && (s.backgroundPosition = x.cbg_img_p)), "" !== x.cbg_o && void 0 !== x.cbg_o && (s.opacity = x.cbg_o), t = 0; t < 4; t++)
                            void 0 !== e.borderStyle && "none" !== e.borderStyle && (void 0 !== e["border" + i[t] + "Width"] && (s["border" + i[t] + "Width"] = Math.round(parseInt(e["border" + i[t] + "Width"]) * L) + "px"), void 0 !== e["border" + i[t] + "Color"] && (s["border" + i[t] + "Color"] = e["border" + i[t] + "Color"])),
                                e["border" + a[t] + "Radius"] && (s["border" + a[t] + "Radius"] = e["border" + a[t] + "Radius"]);
                        for (void 0 !== e.borderStyle && "none" !== e.borderStyle && (s.borderStyle = e.borderStyle), (n = JSON.stringify(s)) !== o[f].emptyObject && n !== x.caches.cbgS && tpGS.gsap.set(x.cbg, s), x.caches.cbgS = n, s = {}, t = 0; t < 4; t++)
                    ...
                    "auto" === T.maxWidth && (T.maxWidth = "inherit"),
                        ...
                        void 0 !== x.vidOBJ && (_.width = x.vidOBJ.width, _.height = x.vidOBJ.height),
                        void 0 !== x.OBJUPD.lppmOBJ && (void 0 !== x.OBJUPD.lppmOBJ.minWidth && (R.minWidth = x.OBJUPD.lppmOBJ.minWidth, w.minWidth = x.OBJUPD.lppmOBJ.minWidth, T.minWidth = x.OBJUPD.lppmOBJ.minWidth), void 0 !== x.OBJUPD.lppmOBJ.minHeight && (R.minHeight = x.OBJUPD.lppmOBJ.minHeight, w.minHeight = x.OBJUPD.lppmOBJ.minHeight, T.minHeight = x.OBJUPD.lppmOBJ.minHeight)),
                        n = JSON.stringify(_),
                        l = JSON.stringify(R),
                        d = JSON.stringify(w),
                        c = JSON.stringify(T),
                        void 0 === x.imgOBJ || void 0 !== x.caches.imgOBJ && x.caches.imgOBJ.width === x.imgOBJ.width && x.caches.imgOBJ.height === x.imgOBJ.height && x.caches.imgOBJ.left === x.imgOBJ.left && x.caches.imgOBJ.right === x.imgOBJ.right && x.caches.imgOBJ.top === x.imgOBJ.top && x.caches.imgOBJ.bottom === x.imgOBJ.bottom || (x.caches.imgOBJ = o.clone(x.imgOBJ), x.imgOBJ.position = "relative", tpGS.gsap.set(x.img, x.imgOBJ)),
                        void 0 === x.mediaOBJ || void 0 !== x.caches.mediaOBJ && x.caches.mediaOBJ.width === x.mediaOBJ.width && x.caches.mediaOBJ.height === x.mediaOBJ.height && x.caches.mediaOBJ.display === x.mediaOBJ.display || (x.caches.mediaOBJ = o.clone(x.mediaOBJ), x.media.css(x.mediaOBJ)),
                        n != o[f].emptyObject && n != x.caches.LOBJ && (tpGS.gsap.set(h, _), x.caches.LOBJ = n),
                        l != o[f].emptyObject && l != x.caches.LPOBJ && (tpGS.gsap.set(x.lp, R), x.caches.LPOBJ = l),
                        d != o[f].emptyObject && d != x.caches.MOBJ && (tpGS.gsap.set(x.m, w), x.caches.MOBJ = d),
    ...
    function (e) {
            ...
            updateNavElementContent: function (e, i, a, o, s) {
                if (void 0 !== t[e].pr_next_key || void 0 !== t[e].pr_active_key) {
                    ...
                    if (!0 === i.enable && i.pi !== g && i.ni !== u) {
                        if (i.pi = g, i.ni = u, i.left.c[0].innerHTML = t.transferParams(i.tmp, t[e].thumbs[g]), u > t[e].slideamount)
                            return;
        ...
        var r = function (e, i) {
                    ...
                    if ((n.top > 0 && n.bottom < t.winH ? 1 : n.top >= 0 && n.bottom >= t.winH ? (t.winH - n.top) / n.height : n.top <= 0 && n.bottom <= t.winH ? n.bottom / n.height : 1) >= t[e].navigation.wheelViewPort) {
                        ...
                        if ("carousel" === t[e].sliderType && !1 === t[e].carousel.snap)
                            ...
                            t[e].sc_indicator_dir = "reverse" === t[e].navigation.mouseScrollReverse && l < 0 || "reverse" !== t[e].navigation.mouseScrollReverse && l > 0 ? 0 : 1,
                                "carousel" == t[e].navigation.mouseScrollNavigation || 0 === t[e].sc_indicator_dir && !s || 1 === t[e].sc_indicator_dir && !o ? void 0 === t[e].pr_processing_key && !0 !== t[e].justmouseScrolled ? (t[e].sc_indicator = "arrow", "carousel" === t[e].sliderType && (t[e].ctNavElement = !0), t.callingNewSlide(e, 0 === t[e].sc_indicator_dir ? 1 : -1, "carousel" === t[e].sliderType), t[e].justmouseScrolled = !0, setTimeout(function () {
            ...
            h = function (e, a) {
                ...
                for (var o in r)
                    r.hasOwnProperty(o) && void 0 !== t[e].navigation[r[o]] && t[e].navigation[r[o]].hide_onleave && p(t[e].navigation[r[o]]) && (g(t[e].navigation[r[o]].hideCall), t[e].navigation[r[o]].hideCall = setTimeout(function (e) {
                        g(e.showCall),
                ...
                if (null != e && void 0 !== e.c) {
                    ...
                    if (!(r <= 0 || o <= 0) && (y(e.c, e, i, o), b(e.c, e, i, r), "outer-left" === e.position ? tpGS.gsap.set(e.c, {
                        ...
                        var s = parseInt(e.padding_top || 0, 0),
                            ...
                            l = {},
                            d = {};
                        e.maxw > a && "outer-left" !== e.position && "outer-right" !== e.position ? (l.left = "0px", l.x = 0, l.maxWidth = a - 2 * e.wpad + "px", d.maxWidth = a - 2 * e.wpad + "px") : (l.maxWidth = e.maxw, d.maxWidth = a + "px"),
                            e.maxh + 2 * e.wpad > t[i].conh && "outer-bottom" !== e.position && "outer-top" !== e.position ? (l.top = "0px", l.y = 0, l.maxHeight = s + n + (t[i].conh - 2 * e.wpad) + "px", d.maxHeight = s + n + (t[i].conh - 2 * e.wpad) + "px") : (l.maxHeight = e.maxh + "px", d.maxHeight = e.maxh + "px"),
            ...
            x = function (e, i, a, r, o) {
                ...
                i.type = r,
                    ...
                    void 0 === i.c && (i.wpad = i.wrapper_padding, i.c = jQuery("<" + p + 's style="opacity:0" class="nav-dir-' + i.direction + " nav-pos-ver-" + i.v_align + " nav-pos-hor-" + i.h_align + " rs-nav-element " + r + "s " + (!0 === i.span ? "tp-span-wrapper" : "") + " " + i.position + " " + (void 0 === i.style ? "" : i.style) + '"><rs-navmask class="' + r + '-mask" style="overflow:hidden;position:relative"><' + p + 's-wrap class="' + r + 's-inner-wrapper" style="position:relative;"></' + p + "s-wrap></rs-navmask></" + p + "s>"), i.c.css({
                        overflow: "visible",
                ...
                "vertical" === i.direction ? (f.css({
                    ...
                    f.click(function () {
                        ...
                        i = void 0 === i ? 0 : i,
                            Math.abs(i) < 10 && (e.revcallslidewithid(g), e.parent().find(s).removeClass("selected"), jQuery(this).addClass("selected"))
                    })
            },
            k = function (e, i, a) {
            ...
            startPanZoom: function (e, i, a, r, o) {
                ...
                if (t[i].panzoomTLs = void 0 === t[i].panzoomTLs ? {} : t[i].panzoomTLs, t[i].panzoomBGs = void 0 === t[i].panzoomBGs ? {} : t[i].panzoomBGs, void 0 === t[i].panzoomBGs[r] && (t[i].panzoomBGs[r] = e), void 0 !== s.panzoom && null !== s.panzoom) {
                    if (e.data("pztl") && e.data("pztl").kill(), a = a || 0, n[0].style.display = "none", 0 == e.find(".rs-pzimg").length) {
                        ...
                        p = void 0 === p ? "" : p,
                            e.append('<rs-pzimg-wrap-parent class="' + p + '" style="z-index:25;width:100%;height:100%;top:0px;left:0px;position:absolute;display:block;overflow: hidden;"><rs-pzimg-wrap class="' + p + '" style="z-index:25;width:100%;height:100%;top:0px;left:0px;position:absolute;display:block"><img class="rs-pzimg" src="' + l + '" style="position:absolute;" width="' + s.owidth + '" height="' + s.oheight + '"></rs-pzimg-wrap></rs-pzimg-wrap-parent>'),
    ...
    function (e) {
        ...
        jQuery.extend(!0, t, {
            checkForParallax: function (e) {
                var r = t[e].parallax;
                if (!r.done) {
                    if (r.done = !0, i && r.disable_onmobile)
                        return !1;
            ...
            updateParallax: function (e, i) {
                ...
                if ("enterpoint" == i.origo && "deviceorientation" !== o.type ? (!1 === i.mouseEntered && (i.mouseEnterX = o.pageX - s, i.mouseEnterY = o.pageY - n, i.mouseEntered = !0), a = i.mouseEnterX - (o.pageX - s), r = i.mouseEnterY - (o.pageY - n), c = i.speed / 1e3 || .4) : "deviceorientation" !== o.type && (a = l / 2 - (o.pageX - s), r = d / 2 - (o.pageY - n)), "deviceorientation" == o.type) {
                    ...
                    if (i.orientationX = g, i.orientationY = u, !m)
                        return;
                ...
                "3D" != i.type && "3d" != i.type || i.sctors.each(function () {
                    var s = jQuery(this),
                        ...
                        m = 0,
                        h = !1;
                    "deviceorientation" === o.type && (n = i.levels[i.levels.length - 1] / 200, l = a * n, d = r * n * 3, p = 0 == t[e].canv.width ? 0 : Math.round(a / t[e].canv.width * n * 500) || 0, g = 0 == t[e].canv.height ? 0 : Math.round(r / t[e].canv.height * n * 700) || 0),
                        s.hasClass("dddwrapper-layer") && (m = i.ddd_z_correction || 65, h = !0),
                        s.hasClass("dddwrapper-layer") && (l = 0, d = 0),
                        u.index() === t[e].pr_active_key || "carousel" != t[e].sliderType ? !i.ddd_bgfreeze || h ? tpGS.gsap.to(s, c, {
                            rotationX: g,
                            rotationY: -p,
                            x: l,
                            z: m,
                ...
                if (t[e].scrollProg = s, t[e].scrollProgBasics = {
                    ...
                    for (var l in t[e].sbas[t.gA(n, "key")])
                        if (void 0 !== t[e]._L[l] && void 0 !== t[e]._L[l].timeline && (1 == t[e]._L[l].animationonscroll || "true" == t[e]._L[l].animationonscroll)) {
                            ...
                            d = d <= 0 ? 0 : d < .1 ? .1 : d,
                                t[e]._L[l].animteToTime !== d && (t[e]._L[l].animteToTime = d, tpGS.gsap.to(t[e]._L[l].timeline, t[e].sbtimeline.speed, {
                                    time: d,
                ...
                if ("3d" != c.type && "3D" != c.type) {
                    ...
                    if (c.bgcontainers)
                        for (p = 0; p < c.bgcontainers.length; p++) {
                            ...
                            h = void 0 !== t[e].parallax.lastBGY && 0 === h && Math.abs(m - t[e].parallax.lastBGY) > 50 ? .15 : h,
                                tpGS.gsap.to(f, h, {
                                    position: "absolute",
                                    top: "0px",
                                    left: "0px",
        ...
        var a = function (e, i) {
            ...
            e.find(".dddwrapper-layertobggroup").appendTo(n),
                "carousel" == t[i].sliderType && (a.ddd_shadow && n.addClass("dddwrappershadow"), tpGS.gsap.set(n, {
            ...
            r = function (e) {
                ...
                if (g) {
                    ...
                    void 0 !== b[0] && t[r].mtl.add(tpGS.gsap.set(b, {
                        ...
                        t[r].mtl.add(tpGS.gsap.set(t[r].pr_next_bg, {
                        ...
                        t[r].mtl.add(tpGS.gsap.set(t[r].pr_next_bg.parent(), {
                            backgroundColor: "transparent"
                        }), 0)
                }
                if (u) {
                    ...
                    void 0 !== _[0] && t[r].mtl.add(tpGS.gsap.set(_, {
                        ...
                        t[r].mtl.add(tpGS.gsap.set(t[r].pr_active_bg, {
                            transformOrigin: "50% 50% 0",
                            transformPerspective: 600,
                            scale: 1,
                            rotationX: 0,
                ...
                if (w = "default" === w || "d" === w ? d.TR[8] || "power2.inOut" : w || d.TR[8] || "power2.inOut", x = "default" === x || "d" === x ? d.TR[9] || "power2.inOut" : x || d.TR[9] || "power2.inOut", requestAnimationFrame(function () {
                    ...
                    if (k.ctx = k.canvas.getContext("2d"), k.oBG_next = t.getByTag(t[r].pr_next_bg[0], "rs-sbg")[0], k.img_next = t.getLoadObj(r, t.gA(k.oBG_next, "src-rs-ref")), k.col_next = t.gA(k.oBG_next, "bgcolor"), u && (k.oBG_act = t.getByTag(t[r].pr_active_bg[0], "rs-sbg")[0], k.img_act = t.getLoadObj(r, t.gA(k.oBG_act, "src-rs-ref")), k.col_act = t.gA(k.oBG_act, "bgcolor")), k.ctx.clearRect(0, 0, k.canvas.width, k.canvas.height), k.canvas.width = t[r].module.width, k.canvas.height = t[r].module.height, k.canvas.style.background = "transparent", k.canvas.style.display = "block", k.oBG_next.style.display = "none", void 0 !== k.col_next && k.col_next.indexOf("gradient") >= 0 && (k.col_next = "transparent"), void 0 !== k.col_act && k.col_act.indexOf("gradient") >= 0 && (k.col_act = "transparent"), 31 === c) {
                        for (var S = "transparent" !== k.col_next && void 0 !== k.col_next ? {
                            ...
                            width: t[r].module.width,
                            height: t[r].module.height
                        } : o("contain" === k.oBG_act.style.backgroundSize, t[r].module.width, t[r].module.height, k.img_act.width, k.img_act.height), T = t[r].module.width / t[r].slots, R = T / 2, O = t[r].module.height, A = [], I = 0; I < t[r].slots + 1; I++)
                            A.push({
                                mt: O,
                                it: O / 4,
                                ml: 0,
                        ...
                        t[r].mtl.add(tpGS.gsap.staggerTo(A, 2 * h / 1e3, {
                            ...
                            onUpdate: function () {
                                ...
                                for (var i = 0; i < t[r].slots + 1; i++) {
                                    ...
                                    s({
                                        ctx: k.ctx,
                                        poly: [[e - R + o, 0 + a], [e + R + 1 + o, 0 + a], [e + 1 + o, O + a], [e - T + o, O + a]],
                                        bg: {
                                        ...
                                        void 0 !== k.col_act && (k.oBG_act.style.display = "none", s({
                                            ctx: k.ctx,
                                            poly: [[e - R + d, 0 + l], [e + R + 1 + d, 0 + l], [e + 1 + d, O + l], [e - T + d, O + l]],
                                            bg: {
                ...
                if (0 == c) {
                    ...
                    t[r].pr_next_bg.find(".slotslide").each(function (e) {
                        z = ++z === C ? 0 : z,
                            ...
                            t[r].mtl.add(tpGS.gsap.from(this, h / 2e3, {
                                opacity: 0,
                                transformStyle: "flat",
                                transformPerspective: 600,
                                scale: 0,
                    ...
                    for (I = 0; I < M.length; I++)
                        t[r].mtl.add(tpGS.gsap.fromTo(M[I], (h - I * (G / t[r].slots)) / 1e3, {
                            zIndex: 10,
                            opacity: 0
                        }, {
                            opacity: 1,
                    ...
                    switch (h = 0 === h ? 10 : h, d.trC) {
                        ...
                        case 1:
                            g && t[r].mtl.add(tpGS.gsap.fromTo(t[r].pr_next_bg, h / 1e3, {
                                ...
                                t[r].mtl.add(tpGS.gsap.fromTo(t[r].pr_active_bg, h / 1e3, {
                                    autoAlpha: 1
                                }, {
                                    autoAlpha: 0,
                                    force3D: "auto",
                        ...
                        case 4:
                            t[r].mtl.add(tpGS.gsap.set(t[r].pr_active_bg.parent(), {
                                ...
                                u && t[r].mtl.add(tpGS.gsap.to(t[r].pr_active_bg, h / 2e3, {
                                    autoAlpha: 0,
                                    force3D: "auto",
                                    ease: w
                                }), 0),
                                g && t[r].mtl.add(tpGS.gsap.fromTo(t[r].pr_next_bg, h / 2e3, {
                                    autoAlpha: 0
                                }, {
                                    autoAlpha: 1,
                                    force3D: "auto",
                        ...
                        case 12:
                            ...
                            g && t[r].mtl.add(tpGS.gsap.fromTo(t[r].pr_next_bg, h / 1e3, {
                                ...
                                jQuery.inArray(d.trC, [6, 8, 10]) >= 0 && t[r].mtl.add(tpGS.gsap.fromTo(t[r].pr_active_bg, h / 1e3, {
                                    autoAlpha: 1,
                                    filter: H,
                                    "-webkit-filter": H
                                }, {
                    ...
                    t[r].mtl.add(tpGS.gsap.set(t[r].pr_next_bg.find("rs-sbg"), {
                        ...
                        u && t[r].mtl.add(tpGS.gsap.set(t[r].pr_active_bg.find("rs-sbg"), {
                            autoAlpha: 1
                        }), 0)
                    ...
                    t[r].mtl.add(tpGS.gsap.set(t[r].pr_active_slide, {
                        ...
                        t[r].mtl.add(tpGS.gsap.set(t[r].pr_next_slide, {
                            zIndex: 15
                        }), 0),
                        t[r].pr_active_bg.find(".slotslide").each(function (e) {
                            t[r].mtl.add(tpGS.gsap.fromTo(this, h / 1e3, {
                                ...
                                t[r].mtl.add(tpGS.gsap.fromTo(this, h / 2e3, {
                                    opacity: 1
                                }, {
                                    opacity: 0,
                                    delay: h / 2e3
                    ...
                    tpGS.gsap.set(t[r].c, {
                        ...
                        22 !== c && 24 !== c || (u && U.push(t[r].pr_active_bg), t[r].mtl.add(tpGS.gsap.fromTo(U, h / 2e3, {
                            z: -200
                        }, {
                            z: 0,
                            ease: "power2.in",
                        ...
                        u && t[r].mtl.add(tpGS.gsap.fromTo(t[r].pr_active_bg, h / 2e3, {
                            z: 0
                        }, {
                            z: -200,
                            ease: "power3.inOut",
                        ...
                        !u || 19 !== c && 23 !== c || t[r].mtl.add(tpGS.gsap.fromTo(t[r].pr_active_bg, h / 2e3, {
                            autoAlpha: 1
                        }, {
                            autoAlpha: 0,
                            ease: "none",
                        ...
                        u && t[r].mtl.add(tpGS.gsap.fromTo(t[r].pr_active_bg, h / 1e3, {
                            overflow: "hidden",
                            rotationX: 0,
                            rotationY: 0,
                            rotationZ: 0,
                    ...
                    h = 0,
                        g && (t[r].mtl.add(tpGS.gsap.fromTo(t[r].pr_next_bg, .001, {
                            autoAlpha: 0
                        }, {
                            autoAlpha: 1,
                            force3D: "auto",
                        ...
                        u && (t[r].mtl.add(tpGS.gsap.to(t[r].pr_active_bg, .001, {
                            autoAlpha: 0,
                            force3D: "auto",
                            ease: w
                    ...
                    null != o.data("currotate") && (l = o.data("currotate")),
                        ...
                        function (e, i) {
                            t[i].slotw = Math.ceil(t[i].module.width / t[i].slots),
                                "fullscreen" == t[i].sliderLayout ? t[i].sloth = Math.ceil(t.getWinH(i) / t[i].slots) : t[i].sloth = Math.ceil(t[i].module.height / t[i].slots)
                        }(0, i);
    ...
    function (e) {
                ...
                if (s.audio = void 0 !== s.audio && s.audio, i && s.opom)
                    ...
                    switch (s.newtype) {
                        case "html5":
                            ...
                            d += "<" + s.tag + " " + l + " " + (s.controls && "none" !== s.controls ? " controls " : "") + ' style="' + ("Edge" !== t.get_browser() ? "object-fit:cover;background-size:cover;opacity:0;width:100%; height:100%" : "") + '" class="" ' + (s.loop ? "loop" : "") + ' preload="' + s.pload + '">',
        ...
        var r = function (e, t, i) {
            ...
            g = function (e, i, a) {
                ...
                e.ifr = i.find("iframe"),
                    ...
                    y(i, a),
                    "mute" == e.volume || 0 === e.volume || t.lastToggleState(i.data("videomutetoggledby")) || !0 === t[a].globalmute ? (e.volumetoken = !0, e.vimeoplayer.setVolume(0)) : n(e, parseInt(e.volcache, 0) / 100 || .75),
                    ...
                    switch (n.type) {
                        case "youtube":
                            if ("undefined" == typeof YT || void 0 === YT.Player)
                                return t.checkVideoApis(e, a), void setTimeout(function () {
                                    u(e, a, r)
                                }, 50);
                        ...
                        case "vimeo":
                            ...
                            for (var h, f = n.ifr.attr("src"), v = {}, _ = f, w = /([^&=]+)=([^&]*)/g; h = w.exec(_);)
                            ...
                            if (k && S && (f += "&background=1"), n.ifr.attr("src", f), n.vimeoplayer = void 0 === n.vimeoplayer || !1 === n.vimeoplayer ? new Vimeo.Player(d) : n.vimeoplayer, k)
                                S ? x = !0 : (n.aplay || "true" === n.aplay) && (x = !0),
                                    x && (n.volumetoken = !0, n.vimeoplayer.setVolume(0), n.volume = "mute");
                            n.vimeoplayer.on("play", function (t) {
                                ...
                                n.vimeoplayer.on("loaded", function (t) {
                                    ...
                                    n.vimeoplayer.getVideoWidth().then(function (t) {
                                        i.width = t,
                                            void 0 !== i.width && void 0 !== i.height && (n.ratio = i.width + ":" + i.height, n.vimeoplayerloaded = !0, s(a, e))
                                    }),
                                ...
                                n.vimeoplayer.on("timeupdate", function (i) {
                                    n.vimeostarted || 0 === i.percent || void 0 !== t[a].activeRSSlide && n.slideid !== t.gA(t[a].slides[t[a].activeRSSlide], "key") || g(n, e, a),
                                        ...
                                        0 != n.esec && -1 !== n.esec && n.esec < i.seconds && !0 !== n.nextslidecalled && (n.loop ? (c(n.vimeoplayer), n.vimeoplayer.setCurrentTime(-1 !== n.ssec ? n.ssec : 0)) : (n.nse && (n.nseTriggered = !0, n.nextslidecalled = !0, t[a].c.revnext()), n.vimeoplayer.pause()))
                                }),
        ...
        var h = function (e, a, s) {
            ...
            if (i && n.notonmobile)
                return !1;
            n.metaloaded = !0,
                n.controls && !n.audio || (0 != e.find(".tp-video-play-button").length || i || e.append('<div class="tp-video-play-button"><i class="revicon-right-dir"></i><span class="tp-revstop">&nbsp;</span></div>'), e.find("video, rs-poster, .tp-video-play-button").click(function () {
                    e.hasClass("videoisplaying") ? n.video.pause() : n.video.play()
                })),
                (n.fcover || e.hasClass("rs-fsv") || n.bgvideo) && (n.fcover || n.bgvideo ? (n.html5vid.addClass("fullcoveredvideo"), void 0 !== n.ratio && 1 != n.ratio.split(":").length || (n.ratio = "16:9"), t.prepareCoveredVideo(a)) : n.html5vid.addClass("rs-fsv")),
                ...
                r(n.video, "timeupdate", function (i) {
                    void 0 !== e && void 0 !== e[0] && !0 !== n.VideoIsVisible && !0 !== n.justReseted && (t.getByTag(e[0], "rs-poster").length > 0 ? (tpGS.gsap.to(t.getByTag(e[0], "rs-poster"), .3, {
                        ...
                        display: "block",
                        ease: "power3.out"
                    }), n.VideoIsVisible = !0, clearTimeout(n.showCoverSoon)),
                        ...
                        void 0 !== n.lastCurrentTime ? n.fps = n.video.currentTime - n.lastCurrentTime : n.fps = .1,
                        n.lastCurrentTime = n.video.currentTime,
                        0 != n.esec && -1 != n.esec && n.esec < n.video.currentTime && !n.nextslidecalled && (n.loop ? (n.video.play(), n.video.currentTime = -1 === n.ssec ? .5 : n.ssec) : (n.nse && (n.nseTriggered = !0, n.nextslidecalled = !0, t[a].jcnah = !0, t[a].c.revnext(), setTimeout(function () {
                            t[a].jcnah = !1
                        }, 1e3)), n.video.pause()))
                }),
                r(n.video, "play", function () {
                    n.nextslidecalled = !1,
                        ...
                        t.is_mobile() || t.isSafari11() || (!0 === t[a].globalmute ? n.video.muted = !0 : n.video.muted = "mute" == n.volume, n.volcache = jQuery.isNumeric(n.volcache) && n.volcache > 1 ? n.volcache / 100 : n.volcache, "mute" == n.volume ? n.video.muted = !0 : null != n.volcache && (n.video.volume = n.volcache)),
                        e.addClass("videoisplaying"),
                        y(e, a),
                        clearTimeout(n.showCoverSoon),
                        !0 !== n.pausetimer || "audio" == n.tag ? (t[a].stopByVideo = !1, t[a].c.trigger("revolution.slide.onvideostop", o(n.video, "html5", n))) : (t[a].stopByVideo = !0, t[a].c.trigger("revolution.slide.onvideoplay", o(n.video, "html5", n))),
                        n.pausetimer && "playing" == t[a].sliderstatus && (t[a].stopByVideo = !0, t[a].c.trigger("stoptimer")),
                ...
                r(n.video, "ended", function () {
                    m(),
                        ...
                        n.nse && n.video.currentTime > 0 && (1 == !t[a].jcnah && (n.nseTriggered = !0, t[a].c.revnext(), t[a].jcnah = !0), setTimeout(function () {
                            t[a].jcnah = !1
                        }, 1500)),
                        e.removeClass("videoisplaying"),
            ...
            y = function (e, i) {
                if (t[i].playingvideos = void 0 === t[i].playingvideos ? new Array : t[i].playingvideos, t[i].videos[e[0].id].stopAV && void 0 !== t[i].playingvideos && t[i].playingvideos.length > 0)
                    for (var a in t[i].lastplayedvideos = jQuery.extend(!0, [], t[i].playingvideos), t[i].playingvideos)
