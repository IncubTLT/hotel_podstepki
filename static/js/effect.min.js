    ...
    function B(r) {
        ...
        return r = r.toLowerCase(), b(t, function (t, e) {
            var n = e.re.exec(r),
                ...
                e = e.space || "rgba";
            if (n)
                return n = i[e](n), i[g[e].cache] = n[g[e].cache], o = i._rgba = n._rgba, !1
        ...
        p = /^([\-+])=\s*(\d+\.?\d*)/, t = [{
            ...
            effect: function () {
                ...
                function f(t) {
                    ...
                    r.mode = c.shift(),
                        !1 === u.uiBackCompat || o ? "none" === r.mode ? (e[a](), n()) : i.call(e[0], r, function () {
                            e.removeData(_),
                                u.effects.cleanUp(e),
                                "hide" === r.mode && e.hide(),
                                n()
            ...
            t.clipInit || (t.start = u(t.elem).cssClip(), "string" == typeof t.end && (t.end = W(t.end, t.elem)), t.clipInit = !0),
                u(t.elem).cssClip({
